...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'loopify.com'
  config.app_name = 'Loopify'
  config.mailer.from = 'Loopify <no-reply@loopify.com>'
  ...
  #
  config.app_secret = 'JBL25Jb8shQlu-4CIccqvvNEj9EfiF8hlF5k0DJC1js_K5uZg95LV_vqX6eZWKwizz0'
